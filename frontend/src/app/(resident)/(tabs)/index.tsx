...
function StatCard({
  ...
  return (
    <View style={[styles.statCard, { borderColor: color, backgroundColor: background }]}>
...
const getStyles = (Colors: ThemeColors) =>
  StyleSheet.create({
    ...
    reviewTitle: { ...Type.subtitle, color: Colors.ink },
    ...
    featuredIcon: { backgroundColor: Colors.warningSoft },
    ...
    featuredMeta: { ...Type.caption, color: Colors.inkSecondary, flexShrink: 1 },
    emptyComplaints: {
      borderRadius: Radius.md,
      borderWidth: StyleSheet.hairlineWidth,
      borderColor: Colors.border,
