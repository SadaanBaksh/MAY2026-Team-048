...
export default function EmployeeLoginScreen() {
  ...
  const handleLogin = () => {
    ...
    if (targetUser && targetUser.role === 'resident') {
      setError('This email belongs to a customer account. Please use Customer Login.');
      return;
    }
  ...
  return (
    <View style={styles.wrapper}>
      <ScreenHeader title="Employee Log In" showBack onBack={() => router.back()} />
      <KeyboardAvoidingView
        style={styles.flex}
        ...
        >
          <Card style={[styles.card, isDesktop && styles.cardDesktop]}>
            ...
            <Text style={styles.subtitle}>
              Log in to manage community complaints, operations, and maintenance tasks.
            </Text>
            ...
            <View style={styles.divider}>
              ...
              <Text style={styles.dividerText}>or explore an employee demo account</Text>
              <View style={styles.dividerLine} />
            </View>
