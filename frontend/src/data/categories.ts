...
export const CATEGORIES: CategoryMeta[] = [
  {
    ...
    keywords: ['leak', 'water', 'pipe', 'tap', 'faucet', 'drain', 'toilet', 'flush', 'seepage', 'flooding'],
  ...
  },
  {
    ...
    keywords: ['power', 'electric', 'spark', 'wire', 'socket', 'switch', 'short circuit', 'mcb', 'trip', 'outage'],
    descriptionTemplates: [
  ...
  },
  {
    ...
    keywords: ['crack', 'wall', 'ceiling', 'tile', 'plaster', 'damp', 'structural', 'paint', 'seepage'],
    descriptionTemplates: [
  ...
  },
  {
    ...
    icon: 'snow-outline',
    defaultPriority: 'Medium',
    keywords: ['ac', 'air conditioner', 'cooling', 'fridge', 'refrigerator', 'appliance', 'geyser', 'heater', 'fan'],
    descriptionTemplates: [
